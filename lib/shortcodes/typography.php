...
class ShortcodesTypography {
	 ...
	 */
	public function wt_horizontal_line($atts) {
	 ...
	 * @return string Output html
	 */
	public function wt_onethird($atts, $content = null) {
	 ...
	 * @return string Output html
	 */
	public function wt_onehalf($atts, $content = null) {
	 ...
	 * @return string Output html
	 */
	public function wt_twothird($atts, $content = null) {
	 ...
	 * @return string Output html
	 */
	public function wt_columns($atts, $content = null) {
	 ...
	 * @return string Output html
	 */
	public function wt_buttons($atts, $content = null){
		extract( shortcode_atts( array(
			'btn' 			=> '',
			'size' 			=> '',
			'block'			=> 'false'
	 ...
	 * @return string Output html
	 */
	public function wt_highlight($atts, $content) {
		extract(shortcode_atts(array(
			"color" => "yellow"
			), $atts));
	 ...
	 * @return string Output html
	 */
	public function wt_infobox($atts, $content) {
		extract(shortcode_atts(array(
			"color" => 	"yellow",
			"size" 	=> 	"full-width",
			"type" 	=> 	"info"
	 ...
	 * @return string Output html
	 */
	public function wt_pricetable($atts, $content) {
		extract(shortcode_atts(array(
			"title" 		=> "Normal",
			"color" 		=> "dark",
			"price" 		=> "0$",
	 ...
	 * @return string Output html
	 */
	public function wt_list($atts, $content){
		extract(shortcode_atts(array(
			'style' => 'normal'
			), $atts));
	 ...
	 * @return string Output html
	 */
	public function wt_divider($atts){
		extract(shortcode_atts(array(
			'size' => 'normal'
			), $atts));
	 ...
	 * @return string Output html
	 */
	public function wt_label($atts, $content = null){
		extract(shortcode_atts(array(
			'label' => ''
			), $atts));
	 ...
	 * @return string Output html
	 */
	public function wt_quote($atts, $content = null){
		extract(shortcode_atts(array(
			'float' 	=> 'none',
			'source' 	=> ''
			), $atts));
	 ...
	 * @return string Output html
	 */
	public function wt_dropcap($atts, $content = null){
		extract(shortcode_atts(array(
			'style' => '1'
			), $atts));
	 ...
	 * @return string Output html
	 */
	public function wt_modal_window($atts, $content = null){
		extract(shortcode_atts( array(
			'btn'		=> '',
			'btn_text' 	=> 'Click me',
			'title'		=> ''
	 ...
	 * @return string Output html
	 */
	public function wt_progress($atts) {
		extract(shortcode_atts(array(
			'progress' 	=> '50',
			'type' 		=> ''
			), $atts));
	 ...
	 * @return string Output html
	 */
	public function wt_video_player($atts, $content = null) {
		extract(shortcode_atts(array(
			'fullwidth' => 'true',
			'width'		=> '100%',
			'height'	=> '420',
